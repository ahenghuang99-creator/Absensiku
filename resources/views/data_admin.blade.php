...
<div class="content-header" style="display:flex; justify-content:space-between; align-items:center; flex-wrap:wrap; gap:15px;">
    ...
    <div style="display:flex; align-items:center; gap:15px;">
        <div class="page-title">
            <i class="fas fa-table"></i> Data Admin
        </div>

        <a href="{{ url('/tambah_admin') }}" class="btn btn-primary">
            <i class="fas fa-plus"></i> Tambah
        </a>
    </div>

    <!-- KANAN -->
    <form action="{{ url('/data_admin') }}" method="GET" style="display:flex; align-items:center; gap:10px;">
    ...
    <div class="print-area">
        <div class="print-header" style="display: flex; align-items: center; gap: 15px; margin-bottom: 20px; padding-bottom: 10px; border-bottom: 2px solid #1e3c72;">
            ...
            <h2 style="margin: 0; font-size: 24px; color: #2c3e50; font-weight: 700;">Data Admin</h2>
        </div>
        ...
        <tbody>
            @forelse ($admins as $index => $admin)
                <tr>
                    ...
                    <td>{{ $admin->email ?? '-' }}</td>
                    <td>
                        <a href="/edit_admin/{{ $admin->id_admin }}" class="btn btn-warning color-white">
                            <i class="fas fa-edit color-white"></i> Edit
                        </a>
                        <a href="/hapus_admin/{{ $admin->id_admin }}" class="btn btn-danger" onclick="return confirm('Yakin ingin menghapus data admin ini?');">
            ...
            @empty
                <tr>
                    <td colspan="5" style="text-align: center; padding: 20px 20;">
                        <i class="fas fa-database"></i> Belum ada data admin.
                    </td>
                </tr>
            @endforelse
        </tbody>
